    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "btc_wallet_address",
                    models.CharField(default="abcdef", max_length=200),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package",
                    models.CharField(help_text="package(ie GOTV Plus)", max_length=200),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="package(ie Asian Add-on)",
                        max_length=200,
                        null=True,
                    ),
                ),
                ...
                (
                    "cablename",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="vtuapp.cable"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        blank=True,
                        help_text="leave blank sytem automatic set this",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ident",
                    models.CharField(
                        default=vtuapp.models.create_id, editable=False, max_length=30
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="vtuapp.network"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        default=1700,
                        help_text="amount your API provider are selling it",
                    ),
                ),
                (
                    "disable_this_exam",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FloatField(
                        default=0.0,
                        help_text="set charge to 0 to set discount for affillitae users",
                    ),
                ),
                (
                    "topuser_discount",
                    models.FloatField(
                        default=0.0,
                        help_text="set charge to 0 to set discount for topuser",
                    ),
                ),
                (
                    "api_discount",
                    models.FloatField(
                        default=0.0,
                        help_text="set charge to 0 to set discountfor api user",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    colorfield.fields.ColorField(
                        default="#132563", image_field=None, max_length=18, samples=None
                    ),
                ),
                (
                    "secondary_color",
                ...
                (
                    "whatsapp_group_link",
                    models.URLField(
                        blank=True, help_text="Support group link if any", null=True
                    ),
                ),
                (
                    "gmail",
                    models.EmailField(
                        blank=True,
                        help_text="Email to get notification on",
                        max_length=254,
                        null=True,
                    ),
                ),
                (
                    "manual_bank_funding_limit",
                ...
                (
                    "affiliate_upgrade_fee",
                    models.IntegerField(
                        blank=True,
                        default=2000,
                        null=True,
                        verbose_name="Upgrade to Affiliate charge",
                    ),
                ),
                (
                    "affiliate_to_topuser_upgrade_fee",
                    models.IntegerField(
                        blank=True,
                        default=3000,
                        null=True,
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        default=5000,
                        null=True,
                        verbose_name="Upgrade to TopUser charge",
                    ),
                ),
                (
                    "affiliate_referral_bonus",
                    models.IntegerField(
                        blank=True,
                        default=500,
                ...
                (
                    "affiliate_to_topuser_referral_bonus",
                    models.IntegerField(
                        blank=True,
                        default=500,
                ...
                (
                    "unverified_users_daily_withdraws_limit",
                    models.PositiveIntegerField(
                        default=5000,
                ...
                (
                    "unverified_users_transfer_limit",
                    models.PositiveIntegerField(
                        default=5000,
                ...
                (
                    "unverified_users_daily_transation_limit",
                    models.PositiveIntegerField(
                        default=30000,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="DATA PIN if any",
                        max_length=10,
                        null=True,
                    ),
                ),
                (
                    "data_vending_medium_for_500_mb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                ...
                (
                    "data_vending_medium_for_1_gb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                        choices=[("OGDAMS1", "OGDAMS1"), ("OGDAMS2", "OGDAMS2")],
                        max_length=100,
                ...
                (
                    "data_vending_medium_for_2_gb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                        choices=[("OGDAMS1", "OGDAMS1"), ("OGDAMS2", "OGDAMS2")],
                        max_length=100,
                ...
                (
                    "data_vending_medium_for_3_gb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                        choices=[("OGDAMS1", "OGDAMS1"), ("OGDAMS2", "OGDAMS2")],
                        max_length=100,
                ...
                (
                    "data_vending_medium_for_5_gb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                        choices=[("OGDAMS1", "OGDAMS1"), ("OGDAMS2", "OGDAMS2")],
                        max_length=100,
                ...
                (
                    "data_vending_medium_for_10_gb_under_ogdams_double_account",
                    models.CharField(
                        blank=True,
                        choices=[("OGDAMS1", "OGDAMS1"), ("OGDAMS2", "OGDAMS2")],
                        max_length=100,
                ...
                (
                    "sim_host_server_id_for_airtime",
                    models.CharField(
                        blank=True,
                        help_text="If you are using simhost",
                        max_length=500,
                        null=True,
                    ),
                ),
                (
                    "sim_host_server_id_for_data",
                    models.CharField(
                        blank=True,
                        help_text="If you are using simhost",
                        max_length=500,
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="Enter 1 for sim1 or 2 for sim2",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="If you are using MSPLUG ",
                        max_length=500,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="If you are using VTU AUTO",
                        max_length=500,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "First_Name",
                    models.CharField(
                        help_text="Your name here", max_length=50, null=True
                    ),
                ),
                ...
                (
                    "Last_Name",
                    models.CharField(
                        help_text="Your Surname", max_length=50, null=True
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        validators=[vtuapp.models.validate_file_size],
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ident",
                    models.CharField(
                        default=vtuapp.models.create_id,
                        editable=False,
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "book_name",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="vtuapp.book"
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="VTU",
                        help_text="VTU or share and Sell",
                        max_length=30,
                    ),
                ),
                ("amount", models.CharField(blank=True, max_length=30)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="network_swap_from",
                        to="vtuapp.network",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network",
                    models.CharField(
                        choices=[("MTN", "MTN")], max_length=30, null=True
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="vtuapp.airtime_to_data_plan",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ident",
                    models.CharField(
                        default=vtuapp.models.create_id, editable=False, max_length=300
                    ),
                ),
                ("fund", models.BooleanField(blank=True, default=False, null=True)),
                (
